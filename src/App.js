...
export default function App() {
  return (
    <div className="bg-[#1A1D26] w-full h-screen font-Montserrat">
      <div>
        <nav className="bg-[#20232C] px-4 py-4 sm:w-full lg:w-3/12 lg:h-screen sm:flex sm:flex-row sm:justify-between sm:items-center lg:flex-col-reverse lg:justify-end lg:py-4 ">
